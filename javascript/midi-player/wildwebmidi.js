    ...
    function(global, env, buffer) {
            ...
            while (1) {
                ...
                case 135:
                    ...
                    case 2:
                        {
                            c[f - 4 >> 2] = b;
                            j = ge(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 5:
                        {
                            c[f - 4 >> 2] = b;
                            j = fc(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 13:
                        {
                            c[f - 4 >> 2] = b;
                            j = $b(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 14:
                        {
                            c[f - 4 >> 2] = b;
                            j = Zb(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 16:
                        {
                            c[f - 4 >> 2] = b;
                            j = tb(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 18:
                        {
                            c[f - 4 >> 2] = b;
                            j = pc(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 19:
                        {
                            c[f - 4 >> 2] = b;
                            j = pa(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0, c[f + (d[b + 7 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 20:
                        {
                            c[f - 4 >> 2] = b;
                            j = Ha[c[f + (d[b + 4 >> 0] << 3) >> 2] & 31](c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 23:
                        {
                            c[f - 4 >> 2] = b;
                            j = ee(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 24:
                        {
                            c[f - 4 >> 2] = b;
                            j = Tb(c[f + (d[b + 4 >> 0] << 3) >> 2] | 0, c[f + (d[b + 5 >> 0] << 3) >> 2] | 0, c[f + (d[b + 6 >> 0] << 3) >> 2] | 0) | 0;
                            if ((Ca | 0) == 1) {
                                Da = f - 8 | 0;
                                return
                            } else
                    ...
                    case 6:
                        {
                            ...
                            Xc(b, h, (d[e + 1 >> 0] << 7 | a[e >> 0] & 127) & 65535);
                            g = k | 2;
                            break a
                        }
                    case 7:
                                            ...
                                            do
                                                if ((a[i + (j + -1) >> 0] | 0) == -9) {
                                                    ...
                                                    do {
                                                        ...
                                                        l = h;
                                                        h = h + 1 | 0
                                                    } while ((a[i + (l + 2) >> 0] | 0) != -9);if ((a[i + h >> 0] | 0) == (128 - f & 255) << 24 >> 24)
                                                        if ((a[i + 4 >> 0] | 0) == 64) {
                                                            h = a[i + 5 >> 0] | 0;
                                                            f = h & 255;
                                                            if ((f & 240 | 0) == 16)
                        ...
                        do {
                            ...
                            if (n >>> 0 < m >>> 0) {
                                ...
                                do {
                                    ...
                                    r = O(y & p, q) | 0;
                                    j = j + 4 | 0
                                } while (j >>> 0 < m >>> 0);j = (c[n >> 2] | 0) == 0 ? n + 4 | 0 : n;
                                if (!r) {
                                    n = j;
                                    j = m
                                } else {
                    ...
                    if (r) {
                        ...
                        if ((n - j | 0) < 2)
                            do {
                                j = j + -1 | 0;
                                a[j >> 0] = 48
                            } while ((n - j | 0) < 2);a[j + -1 >> 0] = (m >> 31 & 2) + 43;
                        j = j + -2 | 0;
                        a[j >> 0] = q;
                        v = j;
                        j = n - j | 0
        ...
        function Ra(b, f) {
            ...
            a: do
                if (f >>> 0 < 14) {
                    ...
                    b: do
                        if ((v | 0) == 22)
                            Hb(11010, 158, 7, 11027, 0);
                        else if ((v | 0) == 24)
                            Hb(11010, 162, 7, 11118, 0);
                        else if ((v | 0) == 26)
                            Hb(11010, 175, 7, 11027, 0);
                        else if ((v | 0) == 28)
                            Hb(11010, 179, 7, 11141, 0);
                        else if ((v | 0) == 32)
                            Hb(11010, 185, 7, 11158, 0);
                        else if ((v | 0) == 36) {
                            j = i * +(t >>> 0) + 0.0;
                            f = ~~j >>> 0;
                            w = b + 8 | 0;
                            ...
                            while (0);A = ab(e[21285] | 0, +g[117], +g[118], +g[119], +g[120]) | 0;
                            c[b + 229964 >> 2] = A;
                            if (!A) {
        ...
        function Sa(f, h) {
            ...
            if (!(td(f, 11172, 18) | 0)) {
                ...
                j = f + 370 | 0;
                a: do
                    if (((M * 17 | 0) + 370 | 0) >>> 0 > h >>> 0)
                        Hb(11191, 115, 14, 11207, 0);
                    else {
                        c[G >> 2] = d[j >> 0];
                        r = -1;
                        q = 0;
                ...
                do {
                    ...
                    while (1) {
                        ...
                        if (!(a[j >> 0] & 64)) {
                            ...
                            if (h & 2)
                                c[k + 64 + (i << 2) >> 2] = ~~(+g[f + 12 + (i * 12 | 0) + 4 >> 2] * 255.0) * 16448;
                            if (h & 1) {
        ...
        function gb(a, b) {
            ...
            a: do
                if ((g | 0) == 0 & (k | 0) == 0)
                    ...
                    f = pe(b) | 0;
                    d = z & 2147483647;
                    if ((e | 0) == 2047 | (d >>> 0 > 2146435072 | (d | 0) == 2146435072 & f >>> 0 > 0))
                        q = 3;
                    else {
                        d = je(i | 0, l | 0, 1) | 0;
                        f = z;
                        if (!(f >>> 0 > k >>> 0 | (f | 0) == (k | 0) & d >>> 0 > g >>> 0))
                            return +((d | 0) == (g | 0) & (f | 0) == (k | 0) ? a * 0.0 : a);
                        if (!e) {
                            d = je(i | 0, l | 0, 12) | 0;
                            f = z;
        ...
        function hb(e, f) {
            ...
            a: do
                if (!(m & 255))
                    ...
                    while (0);l = ec(f, ((c[h >> 2] | 0) >>> (10 - g | 0) >>> 0) / 100 | 0) | 0;
                    if (l | 0) {
                        k = j & 255;
                            ...
                            if (!(a[j >> 0] | 0)) {
                                ...
                                if (a[e + 568 + (m * 7168 | 0) + (k * 56 | 0) + 32 >> 0] & 64)
                                    if ((d[e + 568 + (m * 7168 | 0) + (k * 56 | 0) + 24 >> 0] | 0) < 3)
                                        if (!(a[e + 568 + (m * 7168 | 0) + (k * 56 | 0) + 33 >> 0] & 2))
                                            break a;
            ...
            if ((e + -48 | 0) >>> 0 > 9)
                ...
                do {
                    ...
                    if (e >>> 0 < (c[i >> 2] | 0) >>> 0) {
                        ...
                        e = Ub(a) | 0
                } while ((e + -48 | 0) >>> 0 < 10 & (g | 0) < 214748364);b = ((g | 0) < 0) << 31 >> 31;
                if ((e + -48 | 0) >>> 0 < 10)
                    do {
                        b = Wd(g | 0, b | 0, 10, 0) | 0;
                        g = z;
                        ...
                        if (e >>> 0 < (c[i >> 2] | 0) >>> 0) {
                            ...
                            e = Ub(a) | 0
                    } while ((e + -48 | 0) >>> 0 < 10 & ((b | 0) < 21474836 | (b | 0) == 21474836 & g >>> 0 < 2061584302));if ((e + -48 | 0) >>> 0 < 10)
                    do {
                        e = c[h >> 2] | 0;
                        if (e >>> 0 < (c[i >> 2] | 0) >>> 0) {
                            c[h >> 2] = e + 1;
        ...
        function Sb(d, e) {
            ...
            while (1) {
                ...
                if ((b[c[(c[j >> 2] | 0) + (f << 2) >> 2] >> 1] | 0) == e << 16 >> 16)
                    break;
                else
                    f = f + 1 | 0
            }
        ...
        function uc(b, e, f, g) {
            ...
            c[i >> 2] = f + 1;
            f = e & 255;
            if (a[b + 52 + (f << 5) + 31 >> 0] | 0)
                Sb(b, (d[b + 52 + (f << 5) >> 0] << 8 | h | 128) & 65535);
            return
        }
        function vc() {
            var d = 0
        ...
        function wd(a, b) {
            ...
            e = b >>> 16;
            b = O(e, f) | 0;
            return (z = (a >>> 16) + (O(e, d) | 0) + (((a & 65535) + b | 0) >>> 16) | 0,
            a + b << 16 | c & 65535 | 0) | 0
        }
        function xd(a, b, d, e) {
            a = a | 0;
        ...
        function Fd(b, e) {
            ...
            g = b + 52 + (f << 5) | 0;
            if (!(a[b + 52 + (f << 5) + 31 >> 0] | 0))
                c[b + 52 + (f << 5) + 4 >> 2] = Cc(b, (d[g >> 0] << 8 | c[e + 4 >> 2]) & 65535) | 0;
            else
                a[g >> 0] = c[e + 4 >> 2];
            return
        }
        ...
        function Wd(a, b, c, d) {
            ...
            c = wd(e, f) | 0;
            a = z;
            return (z = (O(b, f) | 0) + (O(d, e) | 0) + a | a & 0,
            c | 0 | 0) | 0
        }
        function Xd(e, f) {
            e = e | 0;
        ...
        function ce(b, c, d) {
            ...
            do {
                ...
                d = d + -1 | 0;
                c = b + d | 0
            } while ((a[c >> 0] | 0) != e << 24 >> 24);return c | 0
        }
        function de(a, b, d) {
            a = a | 0;
            b = b | 0;
